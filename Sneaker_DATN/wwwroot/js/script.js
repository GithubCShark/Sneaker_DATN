...
document.addEventListener('DOMContentLoaded', function () {
  ...
  (function () {
    ...
    var showCatBtns1 = document.querySelectorAll('.show-cat-btn1');
    ...
    if (showCatBtns1) {
      showCatBtns1.forEach(function (showCatBtn) {
        var catSubMenu = showCatBtn.nextElementSibling;
        showCatBtn.addEventListener('click', function (e) {
          e.preventDefault();
          catSubMenu.classList.toggle('visible');
          var catBtnToRotate = document.querySelector('.category__btn1');
          catBtnToRotate.classList.toggle('rotated');
        });
      });
    }
      ...
      var myChart = new Chart(myCanvas, {
        ...
        options: {
          ...
          plugins: {
            ...
            title: {
              display: true,
              text: ['Tổng đơn hàng tháng', 'Tháng 5 - 11'],
              align: 'start',
              color: '#171717',
              font: {
                size: 16,
      ...
      var myCustomersChart = new Chart(customersChartCanvas, {
        ...
        options: {
          ...
          plugins: {
            ...
            title: {
              display: true,
              text: ['Thành viên mới:', '26 người mỗi ngày.'],
              align: 'start',
              color: '#fff',
              font: {
                size: 16,
